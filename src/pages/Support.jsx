...
const Settings = () => {
  ...
  const navigateToProject = ()=>{
    navigate("https://github.com/Sanskar7277");
  }
        ...
        <section className="support-developer d-flex align-items-start justify-content-center w-100 flex-column">
          ...
          <section className="sponsor-me text-muted text-start">
            <section className="icon-section d-flex p-2">
              ...
              <p className=" text-capitalize px-3 text-dark">Reference</p>
            </section>
            Hi, I am Sanskar I built this weather app in 2023 to
            ...
            people would be able to learn and use the things we build.
